...
def minimize_marginals(graph, initial_estimate, pose_options):
    ...
    # Work on copies so the original graph/estimate aren't modified
    ...
    # Sum of marginal covariance entries for BOTH landmarks
    ...
    print(f"pose={best_pose}, landmark=L{best_landmark}, sum_of_marginals = {sum_of_marginals:.6f}")
